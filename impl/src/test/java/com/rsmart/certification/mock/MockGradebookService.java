...
public class MockGradebookService implements GradebookService
{
    ...
    @Override
    public Map<String, CourseGrade> getCourseGradeForStudents( String arg0, List<String> arg1, Map<String, Double> arg2 )
    {
        return null;
    }
    ...
    public String getGradeViewFunctionForUserForStudentForItem(String gradebookUid, String itemName, String studentUid)
   {
    ...
    @Override
    public boolean isValidNumericGrade( String arg0 )
    {
        return false;
    }
